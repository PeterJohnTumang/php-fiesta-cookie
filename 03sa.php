...
function pokemon_defense($lonely, $limit_number){
    for ($a=0; $a < count($lonely); $a++){
        if ($lonely[$a]['defense'] >= $limit_number){
            echo "<br>",
            $lonely[$a]['species'];
        }    
    }
}
echo "Specie with defense greater than 60 are the following: ";
pokemon_defense($lonely,60);
?>