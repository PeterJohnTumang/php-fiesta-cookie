<?php
    ...
    echo "The number of elements in the array is ", count($lonely), ".";
    echo '<br>';
    echo '<br>';
    
    $favorite = $lonely[5]["species"];
    echo "My favorite specie is ", $favorite, ".";
    echo '<br>';
    echo '<br>';

    echo "All species in the list are the following: ";
    foreach ($lonely as $pokemons){
        echo "<br>", $pokemons['species'];
    }
?>